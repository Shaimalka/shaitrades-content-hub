          ...
          <div className="cyber-panel p-5 mb-6">
            ...
            <form onSubmit={submitTrade} className="grid grid-cols-2 md:grid-cols-4 gap-3">
              ...
              <div>
                ...
                <input type="number" step="0.01" value={form.contracts} onChange={e => setForm(f => ({ ...f, contracts: e.target.value }))}
                  className="cyber-input w-full" placeholder="1" required />
              </div>
              <div>
                ...
                <input type="number" step="0.01" value={form.entryPrice} onChange={e => setForm(f => ({ ...f, entryPrice: e.target.value }))}
                  className="cyber-input w-full" placeholder="0.00" required />
              </div>
              <div>
              ...
              <div className="col-span-2 md:col-span-4">
                ...
                <textarea value={form.notes} onChange={e => setForm(f => ({ ...f, notes: e.target.value }))}
                  className="cyber-input w-full h-20 resize-none" placeholder="What happened? Mistakes? Lessons?" />
              </div>
          ...
          <div className="chart-container mb-6">
            ...
            <ResponsiveContainer width="100%" height={180}>
              <BarChart data={chartData} margin={{ top: 5, right: 10, left: 10, bottom: 5 }}>
                ...
                <Tooltip
                  contentStyle={{ background: 'var(--bg-panel)', border: '1px solid var(--border-panel)', borderRadius: 8, fontFamily: 'JetBrains Mono', fontSize: 11 }}
                  ...
                  {[...trades].reverse().map(trade => (
                    <tr key={trade.id} className="border-b hover:bg-white/[0.02] transition-colors" style={{ borderColor: 'var(--border-subtle)' }}>
                      ...
                      <td className="px-4 py-3">
                        <span className="badge-pill" style={trade.direction === 'Long' ? { color: '#00ff88', borderColor: 'rgba(0,255,136,0.3)', background: 'rgba(0,255,136,0.08)' } : { color: '#ff00e5', borderColor: 'rgba(255,0,229,0.3)', background: 'rgba(255,0,229,0.08)' }}>
                          {trade.direction}
                        </span>
                      </td>
