                      ...
                      <div className="premium-card p-5 mb-5">
                                <div className="flex items-center justify-between mb-4">
                                            <div className="flex items-center gap-2">
                                                          ...
                                                          <span className="text-xs font-mono" style={{ color: 'var(--text-muted)' }}>{today}</span>span>
                                            </div>div>
                ...
                {/* EVENING ENTRY */}
                      <div className="premium-card p-5 mb-8">
                                ...
                                <form onSubmit={saveEvening} className="space-y-4">
                                            ...
                                            <div>
                                                          <label className="text-xs font-mono mb-2 block" style={{ color: 'var(--text-muted)' }}>🏷️ Mood tags</label>label>
                                                          <div className="flex flex-wrap gap-2">
                                                            {MOOD_TAGS.map(tag => (
                      ...
                      <div className="mb-8">
                                <div className="flex items-center justify-between mb-4">
                                            <h2 className="section-header" style={{ fontSize: '11px', letterSpacing: '4px' }}>
                                                          // PAST ENTRIES · <span style={{ color: '#00ff88' }}>{pastEntries.length} LOGGED</span>span>
                                            </h2>h2>
                                </div>div>
                        {loading ? (
                                                                                                                                          ...
                                                                                                                                          <div className="px-4 pb-5 border-t" style={{ borderColor: 'var(--border-subtle)' }}>
                                                                                                                                                                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                                                                                                                                                                    ...
                                                                                                                                                                    {entry.moodTags && entry.moodTags.length > 0 && (
                                                                                                                                                                        <div>
                                                                                                                                                                                                      <p className="text-xs font-mono mb-2" style={{ color: 'var(--text-muted)' }}>🏷️ MOOD TAGS</p>p>
