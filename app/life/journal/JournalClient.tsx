                    ...
                    {isExpanded && (
                      <div style={{ padding: '0 16px 20px', borderTop: `1px solid ${isDark ? 'rgba(255,255,255,0.06)' : 'rgba(0,0,0,0.08)'}` }}>
                        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16, marginTop: 16 }}>
                          {entry.morningFocus && <div><p style={{ fontFamily: 'JetBrains Mono, monospace', fontSize: 10, color: (isDark ? 'rgba(255,255,255,0.25)' : 'rgba(0,0,0,0.25)'), marginBottom: 4, textTransform: 'uppercase' }}>🎯 #1 FOCUS</p><p style={{ fontFamily: 'Inter, sans-serif', fontSize: 13, color: (isDark ? '#ffffff' : '#0f1117') }}>{entry.morningFocus}</p></div>}
                          ...
                          {entry.grateful && <div><p style={{ fontFamily: 'JetBrains Mono, monospace', fontSize: 10, color: (isDark ? 'rgba(255,255,255,0.25)' : 'rgba(0,0,0,0.25)'), marginBottom: 4, textTransform: 'uppercase' }}>🙏 GRATEFUL FOR</p><p style={{ fontFamily: 'Inter, sans-serif', fontSize: 13, color: (isDark ? '#ffffff' : '#0f1117') }}>{entry.grateful}</p></div>}
                          {entry.intention && <div><p style={{ fontFamily: 'JetBrains Mono, monospace', fontSize: 10, color: (isDark ? 'rgba(255,255,255,0.25)' : 'rgba(0,0,0,0.25)'), marginBottom: 4, textTransform: 'uppercase' }}>✨ INTENTION</p><p style={{ fontFamily: 'Inter, sans-serif', fontSize: 13, color: (isDark ? '#ffffff' : '#0f1117') }}>{entry.intention}</p></div>}
                          ...
                          {entry.bestMoment && <div><p style={{ fontFamily: 'JetBrains Mono, monospace', fontSize: 10, color: (isDark ? 'rgba(255,255,255,0.25)' : 'rgba(0,0,0,0.25)'), marginBottom: 4, textTransform: 'uppercase' }}>⭐ BEST MOMENT</p><p style={{ fontFamily: 'Inter, sans-serif', fontSize: 13, color: (isDark ? '#ffffff' : '#0f1117') }}>{entry.bestMoment}</p></div>}
                          {entry.doDifferently && <div><p style={{ fontFamily: 'JetBrains Mono, monospace', fontSize: 10, color: (isDark ? 'rgba(255,255,255,0.25)' : 'rgba(0,0,0,0.25)'), marginBottom: 4, textTransform: 'uppercase' }}>🔄 DO DIFFERENTLY</p><p style={{ fontFamily: 'Inter, sans-serif', fontSize: 13, color: (isDark ? '#ffffff' : '#0f1117') }}>{entry.doDifferently}</p></div>}
