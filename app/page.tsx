            ...
            {/* Header */}
                <div className="border-b border-gray-800 px-8 py-5">
                        <div className="flex items-center gap-3">
                                  ...
                                  <div>
                                              <p className="font-bold text-sm text-white">Shaitrades</p>p>
                                              <p className="text-xs text-gray-500">Content Hub</p>p>
                                  </div>div>
                        </div>div>
                </div>div>
            ...
            {/* Platform picker */}
                <div className="flex-1 flex items-center justify-center p-8">
                        <div className="w-full max-w-3xl">
                                  <div className="mb-8">
                                              <span className="font-mono text-xs text-gray-500 tracking-widest uppercase">{'// '}SELECT PLATFORM</span>span>
                                  </div>div>
                                          ...
                                          return (
                                                            <Tag
                                                                              ...
                                                                              <div className="flex items-center justify-between mb-4">
                                                                                                  <span className="text-2xl">{p.icon}</span>span>
                                                                                {p.connected ? (
                                                                                                      ...
                                                                                                      <span className="text-[10px] text-gray-600">OFFLINE</span>span>
                                                                                                  )}
                                                                              </div>div>
                                                                              <h3 className="text-white font-bold text-lg mb-1">{p.name}</h3>h3>
                                                                              <p className="text-xs text-gray-500 mb-3">{p.description}</p>p>
                                                                              <p className="text-xs text-gray-600 font-mono">{p.stats}</p>p>
                                                            </Tag>Tag>
                                                          )
                                    })}
                                  </div>div>
