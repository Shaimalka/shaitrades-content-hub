...
export async function GET(req: NextRequest) {
  ...
  try {
    ...
    const assets = rawAssets ? (typeof rawAssets === 'string' ? JSON.parse(rawAssets) : rawAssets) : []
    const liabilities = rawLiabilities ? (typeof rawLiabilities === 'string' ? JSON.parse(rawLiabilities) : rawLiabilities) : []
