...
export async function POST(req: NextRequest) {
  ...
  try {
        ...
        Identify 6 Instagram accounts in the trading/finance/investing niche that are currently experiencing rapid growth (under 500k followers but growing fast).
