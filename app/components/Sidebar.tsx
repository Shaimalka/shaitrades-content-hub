...
export default function Sidebar() {
  ...
  const SidebarContent = () => React.createElement('div', {
            style: {
                        width: '240px', height: '100vh', background: '#2563eb',
                        display: 'flex', flexDirection: 'column' as const,
                        position: 'fixed' as const, top: 0, left: 0, zIndex: 100, overflowY: 'auto' as const,
            }
  },
                                                                                               ...
                                                                                               return React.createElement(React.Fragment, { key: item.href },
                                                                                                                                    item.section && React.createElement('div', {
                                                                                                                                                      style: {
                                                                                                                                                                          ...
                                                                                                                                                                          padding: '16px 20px 4px', textTransform: 'uppercase' as const,
                                                                                                                                                            }
                                                                                                                                          }, item.section),
                                                                                                                                    React.createElement(Link, {
                                                                                                                                                      ...
                                                                                                                                                      style: {
                                                                                                                                                                          ...
                                                                                                                                                                          padding: '10px 20px', margin: '1px 8px', borderRadius: '8px',
                                                       ...
                                                       React.createElement('div', {
                                                                   style: { padding: '16px', borderTop: '1px solid rgba(255,255,255,0.15)' }
                                                                                 ...
                                                                                 // Bottom row: Light Mode toggle + Settings icon
                                                                                 React.createElement('div', {
                                                                                               style: { display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '12px' }
                                                                                 },
                                                                                                             // Light/Dark toggle — flex:1 so it fills remaining space
                                                                                                             ...
                                                                                                             React.createElement('button', {
                                                                                                                             ...
                                                                                                                             style: {
                                                                                                                                               ...
                                                                                                                                               background: 'rgba(255,255,255,0.1)', border: 'none', borderRadius: '20px',
                                                                                                                                               padding: '8px 10px', color: '#fff', cursor: 'pointer', flexShrink: 0,
                                                                                                                                   }
                                                                                                                   },
                                                                                               ...
                                                                                               style: { display: 'flex', alignItems: 'center', gap: '10px' }
                                                                                                                              ...
                                                                                                                              React.createElement('div', {
                                                                                                                                              style: {
                                                                                                                                                                ...
                                                                                                                                                                display: 'flex', alignItems: 'center', justifyContent: 'center',
                                                                                                                                                                color: '#2563eb', fontSize: '12px', fontWeight: 'bold', flexShrink: 0,
                                                                                                                                                    }
                                                                                                                                    }, initials),
